...
- Automatización quincenal (1 y 15) corriendo en OpenClaw/VPS: keyword research (método Neil Patel), redacción con marca, Google Doc en Drive (carpeta 3_Borradores_automaticos), rotación de responsables, evento en calendario "CarbonBox (todos)" y aviso por correo. (Registro histórico de jun 2026: la "invitación por correo" de entonces dejó de funcionar cuando se comprobó, el 31 ago, que las direcciones @carbonbox.app son alias del organizador. El aviso por correo vigente es el del paso 6b del skill: un mensaje a info@carbonbox.app, no una invitación de calendario.)
...
- Aviso al equipo = DOS canales, los dos obligatorios: (a) evento de día completo en el calendario "CarbonBox (todos)" (calendarId info@carbonbox.app), SIN invitados, con el nombre del responsable al inicio del título; y (b) **correo a info@carbonbox.app** con asunto "<responsable> · Nueva entrada de blog para revisar — <título>". DECISIÓN 1 sep 2026 (Viviana): se añadió el correo porque el evento de calendario pasaba desapercibido y el borrador se quedaba sin editar. El nombre va al inicio del asunto porque el buzón es compartido. No se escribe a las direcciones personales @carbonbox.app: son alias del mismo buzón. El aviso de **"Blog listo para publicar"** (el que sale al terminar la traducción) lleva ahora los mismos dos canales, con asunto "<responsable> · Blog listo para publicar — <título>" y los dos enlaces (Doc ES + Doc EN) en el cuerpo.
